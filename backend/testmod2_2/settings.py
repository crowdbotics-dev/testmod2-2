"""
Django settings for testmod2_2 project.
...
WSGI_APPLICATION = 'testmod2_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testmod2_2 API",
    "DESCRIPTION": "API documentation for testmod2_2 App",
    "VERSION": "v1",
}
